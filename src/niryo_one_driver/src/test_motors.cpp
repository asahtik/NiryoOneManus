...
// TODO: read urdf and get joint limits
...
//     std::string urdf_str;
//     // TODO: Get param
//     // auto param = nh.getParam("robot_description", urdf_str);
//     if (param) // Check for robot_description in proper namespace
//     {
...
//     while(!getState().isDone() && ok && enable_test)
//     {
//         repl::sleep(0.1);
//     }
