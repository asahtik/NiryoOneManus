...
void CanCommunication::getCurrentPositionV2(double *axis_1_pos, double *axis_2_pos, double *axis_3_pos)
{
    ...
    *axis_3_pos = steps_to_rad_pos(m3.getPositionState(), m3.getGearRatio(), m3.getDirection());
    OUTPUT_INFO("Position command: %d, %d, %d; Position state: %d, %d, %d", m1.getPositionCommand(), m2.getPositionCommand(), m3.getPositionCommand(), m1.getPositionState(), m2.getPositionState(), m3.getPositionState());
}
